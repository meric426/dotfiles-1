...
brew "autoconf"
# Cryptography and SSL/TLS Toolkit — disabled in homebrew-core 2024-11-11, fails on fresh install
# brew "openssl@1.1"
# Old Python pulled in as a dependency; anything needing it will install it itself
# brew "python@3.10"
...
brew "gcc"
# Manage your Google Compute Engine resources — formula removed from homebrew-core (tool dead since ~2015)
# brew "gcutil"
...
brew "kubectx"
# kubectl 1.22 — disabled in homebrew-core 2023-08-28; use plain "kubernetes-cli" if needed
...
brew "postgis"
# Object-relational database system — old majors; uncomment if restoring pre-17 clusters
# brew "postgresql@15"
# brew "postgresql@16"
...
brew "prometheus"
# Old Python; anything needing it will install it itself
# brew "python@3.11"
# Interpreted, interactive, object-oriented programming language
brew "python@3.12"
# Deprecated, disabled in homebrew-core 2026-10-15
# brew "python@3.9"
...
brew "zsh"
# Static analysis for shell scripts (used to lint install.sh)
brew "shellcheck"
...
# Cargo tools need a rustup toolchain first (`rustup default stable`); run `cargo install cargo-insta cargo-watch` after
# cargo "cargo-insta"
# cargo "cargo-watch"
# npm globals are managed under nvm's node, not brew's — install.sh installs them after nvm setup
